...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <span class="brand-text font-weight-light">Saka gas</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
              <router-link to="/admin/products/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Product List</p>
                </router-link>
              </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                        <router-link to="/admin/brand/create" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Add category</p>
                        </router-link>
                    </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link to="/admin/branch/create" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Branch</p>
                </router-link>
              </li>
              <li class="nav-item">
              <router-link to="/admin/branch/index" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Branch</p>
                </router-link>
              </li>
